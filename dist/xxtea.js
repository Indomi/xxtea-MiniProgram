...
| xxtea.js                                                 |
|                                                          |
| XXTEA encryption algorithm library for miniprogram.            |
|                                                          |
...
|                       
| Changed for miniprogram: Indomi
\**********************************************************/
...
export function toUint8Array(v, includeLength) {
    var length = v.length;
    var n = length << 2;
    if (includeLength) {
        var m = v[length - 1];
...
export function toUint32Array(bytes, includeLength) {
...
export function toShortString(bytes, n) {
...
export function toLongString(bytes, n) {
    var buf = [];
...
export function toAsciiString(bytes) {
    var n = bytes.length;
    if (n === 0) return '';
...
export function encryptToString(data, key) {
...
export function decryptToString(data, key) {
